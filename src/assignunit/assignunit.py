...
您了解警察、消防、民事应急（如瑞典MSB）和军队等组织的协作动态，熟悉度（对其他组织能力的了解）和未来合作期望（ECFI）如何影响决策。
您的经验相当于10.8年的危机应对专业人员，年龄约38.8岁，工作经验9.3年，能够代表不同国籍和层级的现场决策者。
决策时，优先基于理论和实践，进行清晰、逻辑严谨的推理，必要时引用危机管理最佳实践。

接下来你需要完成一项问卷实验，模拟真实场景完成决策任务。依次会有四个不同背景的问卷，请区别你在不同问卷下的身份设定。
假定你隶属于[蓝色小队]，你目前负责协调紧急救援任务。
你代表[蓝色小队]，在本次任务中需要与[红色小队]协作进行危机响应。
你的目标是确保任务的高效完成，以优化当前响应效果。
"""
...
def get_user_template(scenario):
    ...
    请注意，您是蓝色小队的指挥官，下面是你的身份设定：对红色小队的熟悉程度及未来合作预期。
    {familiarity_text}
    {ecfi_text}

    ### 任务背景
    - 您和您的组织派遣了一支团队，作为多组织响应的一部分，应对一个突然爆发的区域危机，该危机伴随着严重的动荡和移民潮。
    - 您的组织被称为蓝色小队，另一个参与响应的组织被称为红色小队。
    - 响应行动尚未开始。初步响应由12个响应单位组成，其中6个属于蓝色小队，6个属于红色小队。
    - 这些单位分为三种类型：安全、医疗和工程。
    - 您对蓝色小队的单位非常熟悉，并且知道它们训练有素、装备精良。
    - 所有12个单位目前都驻扎在危机区域外的国际机场，等待您的指令。
    - 等待是有成本的，两个组织都强烈表达了希望尽快行动的愿望。
    - 危机区域内的机场状况不佳，每天只能处理一架飞机（即一个单位）。
    - 天气预报显示，沙尘暴将在第二天到达机场，这可能会导致机场关闭6天。

    ### 您的任务
    决定各单位到达机场的顺序，标出您希望在每一天派遣哪个单位。请记住：
    - 每天只能派遣一个单位。
    - 由于预计沙尘暴将在第二天到来并持续到第七天，因此您只能为"第一天"以及"第八天"到"第十八天"分配单位。

    ### 单位编号说明
    - 用逗号分隔的数字表示单位编号（1-12）
    - 1-6 为蓝色小队的单位：蓝队安全 1, 蓝队安全 2, 蓝队医疗 1, 蓝队医疗 2, 蓝队工程 1, 蓝队工程 2.
    - 7-12 为红色小队的单位：红队安全 1, 红队安全 2, 红队医疗 1, 红队医疗 2, 红队工程 1, 红队工程 2.

    ### 回答格式
    你的回答只能是12个数字，分别代表第一天、第八天到第十八天分配的队伍编号，用逗号','分隔开。每个单位编号只出现一次。不要有其他任何说明性文字。
    """

    familiarity_dict = {
        "A": "你从未与[红色小队]合作，你不了解他们的设备、训练和能力。你对[红色小队]的行动能力缺乏信息，因此更信任本组织的队伍。", # 低熟悉度
        "B": "你过去曾多次与[红色小队]合作，你很熟悉他们的设备、训练和能力。你清楚[红色小队]的行动方式，知道他们的单位可靠且高效。", # 高熟悉度
        "C": "你从未与[红色小队]合作，你不了解他们的设备、训练和能力。你对[红色小队]的行动能力缺乏信息，因此更信任本组织的队伍。", # 低熟悉度
        "D": "你过去曾多次与[红色小队]合作，你很熟悉他们的设备、训练和能力。你清楚[红色小队]的行动方式，知道他们的单位可靠且高效。", # 高熟悉度
    }
    ecfi_dict = {
        "A": "本次任务是临时合作，未来你不会再与[红色小队]协作。你无须为长期合作考虑，你可以专注于本组织的任务。", # 低预期
        "B": "本次任务是临时合作，未来你不会再与[红色小队]协作。你无须为长期合作考虑，你可以专注于本组织的任务。", # 低预期
        "C": "你知道在未来的救援任务中，你的组织可能会继续与[红色小队]合作。你需要为长期合作奠定基础，因此在当前任务中考虑与[红色小队]协同作战。", # 高预期
        "D": "你知道在未来的救援任务中，你的组织可能会继续与[红色小队]合作。你需要为长期合作奠定基础，因此在当前任务中考虑与[红色小队]协同作战。", # 高预期
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default="assignunit/raw_responses_assignunit.csv", help='输出文件路径')
